...
## Documents
Rephine_1.1.0.tar.gz is the R scource code packages to process Pharmacogenomic data and ChIP-seq data by using RePhine. For details and guides, please see RePhine User Guide.
